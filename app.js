...
function initSlideshow() {
  ...
  function goTo(idx) {
    ...
    document.querySelectorAll('.cortes-dot').forEach((d, i) => d.classList.toggle('active', i === current));
  ...
  // Setas
  document.getElementById('cortes-prev').onclick = () => goTo(current - 1);
  document.getElementById('cortes-next').onclick = () => goTo(current + 1);
